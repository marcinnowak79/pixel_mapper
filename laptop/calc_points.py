...
files = ['ready_data_1.txt','ready_data_2.txt','ready_data_3.txt']

fov = [65, 42] #field of view of the camera [degreesHorizontal,degreesVertical]
res = [1920, 1080] #resolution (in pixels) of the camera [Horizontal, Vertical]
D = 265  #distance (in any units) from the camera to the center of the triangle
...
f1 = open("raw.csv",'w')
#f1.write(dataout)
np.savetxt("raw.txt",dataout,delimiter=',')
f1.close()
